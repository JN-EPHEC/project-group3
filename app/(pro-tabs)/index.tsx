      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.container}>
          <View style={styles.header}>
            <Text style={[styles.title, { color: PRO_COLOR }]}>Accueil</Text>
          </View>
            ...
            {displayedEvents.length > 0 ? (
              <>
                {displayedEvents.map((event: any) => (
                  ...
                  >
                    ...
                    <View style={styles.eventMetaRow}>
                      {event.location ? <Text style={[styles.eventLocation, { color: PRO_COLOR }]}>{event.location}</Text> : null}
                      <Text style={[styles.rowCardDate, { color: PRO_COLOR }]}>
                        {event.date?.toDate().toLocaleDateString('fr-FR', { day: 'numeric', month: 'short' })}
                      </Text>
                      <Text style={[styles.eventTime, { color: PRO_COLOR }]}>
                        {event.isAllDay 
                          ? 'Toute la journée' 
                ...
                {events.length > 3 && (
                  ...
                  >
                    {showAllEvents ? (
                      <Text style={[styles.seeMoreText, { color: PRO_COLOR }]}>Voir moins</Text>
                    ) : (
                      <Text style={[styles.seeMoreText, { color: PRO_COLOR }]}>Voir plus</Text>
                    )}
                  </TouchableOpacity>
                )}
              </>
          ...
          <View style={styles.section}>
            <Text style={[styles.sectionTitle, { color: PRO_COLOR }]}>Messages non lus</Text>
            {messages.length > 0 ? (
