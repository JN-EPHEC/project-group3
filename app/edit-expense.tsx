        ...
        <ScrollView style={styles.scrollView}>
          <View style={styles.container}>
            ...
            <View style={styles.header}>
              <Text style={[styles.title, { color: colors.tint }]}>Modifier la dépense</Text>
            </View>
            ...
            <View style={styles.form}>
              ...
              <View style={styles.inputGroup}>
                <Text style={[styles.label, { color: colors.text }]}>Ticket de caisse / Photo</Text>
                {(imageUri || existingImageUrl) ? (
                  ...
                  <TouchableOpacity style={[styles.imageButton, { backgroundColor: colors.cardBackground }]} onPress={handlePickImage}>
                    ...
                    <Text style={[styles.imageButtonText, { color: colors.tint }]}>Ajouter une image</Text>
                  </TouchableOpacity>
                )}
              </View>
